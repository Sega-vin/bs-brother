	...
	<?php if (have_posts()): ?>
        ...
        <div class="tabs" id="js-tabs">
            <div class="tabs__header">
                ...
                <?php if($i === 1){ $active_tab_title = 'active';} ?>
                    <div data-tab="tab-<?php echo $i; ?>" class="tabs__title <?php echo $active_tab_title; ?>"><?php echo $tab['crb_radio']; ?></div>
                <?php $i++; endforeach; ?>
            </div>
                            ...
                            <div class="single-product__wrap">
								<?php if ($single_banner): ?>
                                    <div class="banner-wrap">
										...
										<?php $banner_link = carbon_get_post_meta(get_the_ID(), 'crb_product_singel_update_button_link'); ?> <?php if ($banner_link): ?>
