<?php
/**
 * bs-brother functions and definitions
 *
...
if ( ! function_exists( 'bs_brother_setup' ) ) :
	...
	function bs_brother_setup() {
		 ...
		 * If you're building a theme based on bs-brother, use a find and replace
		 * to change 'bs-brother' to the name of your theme in all the template files.
		 */
